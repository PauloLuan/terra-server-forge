...
angular.module('terramobileserver',['ngRoute','ngResource'])
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/FormSchemas',{templateUrl:'views/FormSchema/search.html',controller:'SearchFormSchemaController'})
      .when('/FormSchemas/new',{templateUrl:'views/FormSchema/detail.html',controller:'NewFormSchemaController'})
      .when('/FormSchemas/edit/:FormSchemaId',{templateUrl:'views/FormSchema/detail.html',controller:'EditFormSchemaController'})
